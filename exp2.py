...
check_block_size =  int(sys.argv[1])       #second
...
print("check_block_size=",check_block_size)
print("*******************************")
g=open("result\\block_size data.txt","a")
g.write(f"{safety[0]},{check_block_size},LOS\n")
g.write(f"{safety[1]},{check_block_size},NMAC\n")
g.write(f"{round(efficiency)},{check_block_size},Ground Delay\n")